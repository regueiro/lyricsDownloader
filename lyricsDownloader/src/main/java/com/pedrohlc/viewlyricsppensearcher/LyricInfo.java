...
public class LyricInfo {
	...
	public Long getLyricRatesCount() {
		return ratecount;
	}

	public Long getLyricDownloadsCount() {
	...
	public void setLyricRatesCount(Long value) {
		ratecount = value;
	}

	public void setLyricDownloadsCount(Long value) {
	...
	public String dump() {
		...
		return String
				.format("<fileinfo filetype=\"lyrics\" link=\"%s\" filename=\"%s\" artist=\"%s\" title=\"%s\" album=\"%s\" uploader=\"%s\" rate=\"%f\" ratecount=\"%d\" downloads=\"%d\" timelength=\"%s\"/>",
						url, name, artist, title, album, uploader, rate,
						ratecount, downloadscount, timelength);
	}
}
